...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/pascal/Git/Schnurbus/kegelmaster/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/pascal/Git/Schnurbus/kegelmaster/public/storage',
...
'debugbar.queries.explain','sanctum.csrf-cookie','api.v1.club.show','api.v1.player.show','home','dashboard','set-club','save-dashboard',
'club.index','club.create','club.store','club.show','club.edit',
'club.update','club.destroy','role.index','role.create','role.store',
'role.show','role.edit','role.update','role.destroy','players.invite.store',
'players.index','players.create','players.store','players.show','players.edit',
'players.update','players.destroy','matchdays.add-player','matchdays.remove-player','matchdays.index',
'matchdays.create','matchdays.store','matchdays.show','matchdays.edit','matchdays.update',
'matchdays.destroy','fee-entries.bulk-update','fee-type.index','fee-type.create','fee-type.store',
'fee-type.show','fee-type.edit','fee-type.update','fee-type.destroy','competition-entries.bulk-update',
'competition-type.index','competition-type.create','competition-type.store','competition-type.show','competition-type.edit',
'competition-type.update','competition-type.destroy','transactions.index','transactions.create','transactions.store',
'transactions.show','transactions.edit','transactions.update','transactions.destroy','players.invitation.accept','profile.edit','profile.update','profile.destroy','password.edit',
...
'app','emails.player_invitation','emails.player_invitation-text','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
